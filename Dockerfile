...
RUN python2 -c "import locale; locale.setlocale(locale.LC_CTYPE, locale.getdefaultlocale())" \
	&& python3 -c "import locale; locale.setlocale(locale.LC_CTYPE, locale.getdefaultlocale())" \
